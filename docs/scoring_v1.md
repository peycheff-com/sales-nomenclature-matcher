# Scoring Formula v1 / Формула скоринга v1
...
- critical_number_conflict: -0.18 для specific product with identifiers, -0.08 для generic product без identifiers
- category_conflict: -0.15
- packaging_conflict: -0.12
- unit_conflict: -0.10
- brand_conflict без article/mfr code match: -0.08
