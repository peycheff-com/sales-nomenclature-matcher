...
class CatalogRepo:
    ...
    async def upsert_products(self, items: list[dict]) -> int:
        ...
        stmt = stmt.on_conflict_do_update(
            ...
            set_={
                "onec_ref": stmt.excluded.onec_ref,
                ...
                "normalized_full_name": stmt.excluded.normalized_full_name,
                "normalized_brand": stmt.excluded.normalized_brand,
                "manufacturer": stmt.excluded.manufacturer,
                "manufacturer_code": stmt.excluded.manufacturer_code,
                "category_id": stmt.excluded.category_id,
                "category_path": stmt.excluded.category_path,
                "unit": stmt.excluded.unit,
                "packaging": stmt.excluded.packaging,
                "size_value": stmt.excluded.size_value,
                "size_unit": stmt.excluded.size_unit,
                "weight_value": stmt.excluded.weight_value,
                "weight_unit": stmt.excluded.weight_unit,
                "volume_value": stmt.excluded.volume_value,
                "volume_unit": stmt.excluded.volume_unit,
                "attributes_json": stmt.excluded.attributes_json,
