...
Каскадный pipeline:
1. Нормализация текста (9 этапов: unicode, кириллица/латиница, числа, единицы, сокращения/синонимы, упаковка, бренды, стоп-слова, токенизация)
...
| GET /api/v1/review/queue | Получить очередь на ревью |
| GET /api/v1/suppliers | Список разработчиков / поставщиков |
